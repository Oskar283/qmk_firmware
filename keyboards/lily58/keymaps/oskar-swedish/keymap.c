...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(LCTL(SE_Z), KC_F1, tKC_F2, KC_F3, KC_F4, KC_F5,			KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11,
			  KC_TAB, SE_Q, SE_W, SE_F, SE_P, SE_B,				SE_J, SE_L, SE_U, SE_Y, KC_SCLN, KC_MINS,
			  KC_GESC, SE_A, SE_R, LSFT_T(SE_S), LCTL_T(SE_T), SE_G,	SE_M, LCTL_T(SE_N), LSFT_T(SE_E), SE_I, SE_O, KC_QUOT,
