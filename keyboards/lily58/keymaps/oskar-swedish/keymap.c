...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(LCTL(SE_Z), KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,			KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11,
			  KC_TAB, SE_Q, SE_W, SE_F, SE_P, SE_B,				SE_J, SE_L, SE_U, SE_Y, SE_SEMICOLON, SE_QOU,
			  KC_GESC, SE_A, SE_R, LSFT_T(SE_S), LCTL_T(SE_T), SE_G,	SE_M, LCTL_T(SE_N), LSFT_T(SE_E), SE_I, SE_O, SE_DQOU,
	...
	[1] = LAYOUT(KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DOT, SE_1, SE_2, SE_3, SE_4, SE_5, SE_6, SE_7, SE_8, SE_9, SE_0, SE_MINS, KC_GRV, SE_EXLM, SE_AT, SE_HASH, SE_DLR, SE_PERC, SE_CIRC, SE_AMPR, SE_ASTR, SE_LPRN, SE_RPRN, SE_TILD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, SE_UNDS, SE_PLUS, SE_LCBR, SE_RCBR, SE_QUES, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
